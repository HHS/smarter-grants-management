...
import { ApplicationPackageFieldValueKey } from "tests/e2e/announcement/fixtures/application-package-field-definitions";
...
/** Builds happy-path ApplicationPackage form data keyed by field definitions. */
