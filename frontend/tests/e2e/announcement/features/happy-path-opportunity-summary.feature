...
# Related spec: e2e/announcement/specs/happy-path-opportunity-summary.spec.ts
...
Feature: Opportunity summary happy path draft completion
  ...
  Scenario: Happy path opportunity summary
    ...
    And I use direct URL "/announcements" to navigate to the "Opportunities List" page
