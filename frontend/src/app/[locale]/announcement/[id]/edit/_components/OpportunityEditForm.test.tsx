...
describe("OpportunityEditForm â€” rendering", () => {
  beforeEach(() => {
...
describe("OpportunityEditForm â€” alert banners", () => {
  beforeEach(() => {
    mockUseActionState.mockReturnValue([
      { validationErrors: {} },
      jest.fn(),
...
describe("OpportunityEditForm â€” conditional fields", () => {
  beforeEach(() => {
    mockUseActionState.mockReturnValue([
      { validationErrors: {} },
      jest.fn(),
...
describe("OpportunityEditForm â€” eligibility checkboxes", () => {
  beforeEach(() => {
    mockUseActionState.mockReturnValue([
      { validationErrors: {} },
      jest.fn(),
...
describe("OpportunityEditForm â€” save state", () => {
  afterEach(() => {
    jest.resetAllMocks();
  });
...
describe("OpportunityEditForm â€” funding details interactions", () => {
  beforeEach(() => {
    mockUseActionState.mockReturnValue([
      { validationErrors: {} },
      jest.fn(),
...
describe("OpportunityEditForm â€” eligibility and additional info interactions", () => {
  beforeEach(() => {
    mockUseActionState.mockReturnValue([
      { validationErrors: {} },
      jest.fn(),
...
describe("OpportunityEditForm â€” inline validation errors", () => {
  afterEach(() => {
    jest.resetAllMocks();
  });
...
describe("OpportunityEditForm â€” number formatting edge cases", () => {
  beforeEach(() => {
    mockUseActionState.mockReturnValue([
      { validationErrors: {} },
      jest.fn(),
...
describe("OpportunityEditForm â€” field validations on exiting the field", () => {
  beforeEach(() => {
    mockUseActionState.mockReturnValue([
      { validationErrors: {} },
      jest.fn(),
