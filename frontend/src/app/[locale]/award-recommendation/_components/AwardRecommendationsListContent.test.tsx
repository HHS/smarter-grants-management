...
import AwardRecommendationsListContent from "src/app/[locale]/award-recommendation/_components/AwardRecommendationsListContent";
...
jest.mock(
  "src/app/[locale]/award-recommendation/_components/AwardRecommendationsListHeader",
  () => ({
    __esModule: true,
    default: (props: {
      awardRecommendationsCount: number;
...
jest.mock(
  "src/app/[locale]/award-recommendation/_components/AwardRecommendationsListTable",
  () => ({
    __esModule: true,
    default: (props: {
      currentAgencyId: string;
