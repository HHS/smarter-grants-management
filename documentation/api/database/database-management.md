...
1. Manually update the database models with the changes ([example_models.py](https://github.com/HHS/grants-shared/blob/main/backend/grants_shared/src/grants_shared/db/models/base.py) in this example)
```python
...
```python
class Example(GrantorSchemaTable, TimestampMixin):
