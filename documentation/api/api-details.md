...
@example_blueprint.auth_required(jwt_or_api_user_key_multi_auth) # Supports both JWT (X-MGMT-Token) and API User Key (X-API-Key) auth
...
The Swagger UI  can be reached locally at [http://localhost:8089/docs](http://localhost:8089/docs) when running the API.
![Swagger UI](./images/swagger-ui.png)

The actual openapi spec generated that backs this swagger UI can be seen at [http://localhost:8089/openapi.json](http://localhost:8089/openapi.json)
