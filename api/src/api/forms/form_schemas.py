...
class FormSchema(Schema):
    ...
    form_id = fields.Integer(
        metadata={"description": "Unique identifier of the form"}
    )
    ...
    name = fields.String(
        metadata={"description": "The full name of the form", "example": "Application for Federal Assistance (SF-424)"}
    )
    ...
    version = fields.String(
        metadata={"description": "The version of the form", "example": "4.0"}
    )

    form_family = fields.List(
        fields.Enum(FormFamily), metadata={"description": "The form families that the form belongs to", "example": [FormFamily.SF_424]}
    )
