...
variable "enable_newrelic" {
  type        = bool
  description = "Whether to create the New Relic log forwarders (ECS host logs, API Gateway logs, and ALB access logs). When false, the /new-relic-license-key SSM parameter is not required."
  default     = false
}
