...
variable "enable_newrelic" {
  type        = bool
  description = "Whether to create the New Relic log forwarder for this domain's CloudWatch logs. When false, the /new-relic-license-key SSM parameter is not required."
  default     = false
}
